...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden min-h-[100svh]">
      ...
      {/* Contrast scrim only on the left half to help text/icons stand out */}
      <div className="pointer-events-none absolute inset-0 z-20 bg-gradient-to-r from-[#0B0F14]/80 via-[#0B0F14]/55 to-transparent" />

      {/* Blur halo that follows the name */}
      <BlurHalo
      ...
      <div className="relative z-30 mx-auto grid min-h-[100svh] max-w-6xl grid-cols-1 items-center gap-10 px-6 pt-20 md:grid-cols-2 md:pt-24">
        {/* Left: name, role, typewriter, actions */}
        <div className="text-center md:text-left">
          <div id="hero-nameblock" className="inline-block">
            ...
            {/* designation improved */}
            <p className="mt-3 text-base md:text-xl font-medium tracking-wide text-white/95 drop-shadow-[0_2px_6px_rgba(0,0,0,0.6)]">
              Software Engineer · Backend &amp; Full-Stack
            </p>
          </div>

          {/* Typewriter */}
          <div className="mt-6 mx-auto max-w-2xl rounded-xl border border-white/20 bg-black/35 backdrop-blur-md px-4 py-3 shadow-[0_8px_30px_rgba(0,0,0,0.35)]">
            <div className="text-xs text-white/70">Ask:</div>
            <div className="mt-1 text-sm text-white/85">tell me your skills</div>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3 md:justify-start">
            <a
              href="#contact"
              className="px-5 py-2 rounded font-semibold bg-white text-[#0B0F14] hover:bg-white/90 transition focus:outline-none focus:ring-2 focus:ring-white/50"
            >
              Contact me
            </a>
            <a
              href="#about"
              className="px-5 py-2 rounded border border-white/30 text-white hover:border-white/60 hover:bg-white/10 transition focus:outline-none focus:ring-2 focus:ring-white/30"
            >
              Learn more
            </a>
          </div>

          {/* Socials + Resume — higher contrast, larger icons, clear glow */}
          <div className="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-black/50 border border-white/30 text-white hover:bg-black/60 hover:border-white/60 transition focus:outline-none focus:ring-2 focus:ring-white/40 shadow-[0_0_18px_rgba(0,0,0,0.45)]"
              aria-label="GitHub"
              title="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-[#0A66C2]/70 border border-white/30 text-white hover:bg-[#0A66C2]/80 hover:border-white/60 transition focus:outline-none focus:ring-2 focus:ring-[#59b3e3]/60 shadow-[0_0_18px_rgba(10,102,194,0.45)]"
              aria-label="LinkedIn"
              title="LinkedIn"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
              href="/resume"
              className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-yellow-500/25 border border-yellow-300/50 text-white hover:bg-yellow-500/35 hover:border-yellow-300/70 transition focus:outline-none focus:ring-2 focus:ring-yellow-300/70 shadow-[0_0_18px_rgba(255,215,0,0.45)]"
              aria-label="Resume"
              title="Resume"
            >
